...
This module is optional but highly recommended as it converts the iso 8601 dates to friendly date strings
e.g. 4 days ago
...
5. Go to Administer > Site configuration > Social River  and set the Feed limit (amount of feed items to show) and
   enable the services
   you wish to allow.
6. Got Administer > Site building > Blocks   and set the social river block to display in the region of your choice.
7. Go to "My account" and edit your profile - you will see a tab for social river - click on that and set your username
   for the services you wish to display.
